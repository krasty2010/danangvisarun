  ...
  return (
    <section id="booking" className="section bg-gray-50">
      <div className="container-custom">
        <h2 className="section-title">Choose Your Trip Date</h2>
        ...
        <div className="mx-auto max-w-4xl rounded-2xl bg-white p-6 shadow-medium md:p-8">
          <div className="mb-8 flex items-center justify-between">
            ...
            <h3 className="text-center text-xl font-semibold md:text-2xl">
              {monthsInEnglish[currentDate.getMonth()]} {currentDate.getFullYear()}
            </h3>
          ...
          <div className="mt-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center text-text-secondary">
              ...
              <span>
                {selectedDate
                  ? `Selected date: ${selectedDate.getDate()} ${monthsInEnglish[selectedDate.getMonth()]} ${selectedDate.getFullYear()}`
              ...
              href={
                selectedDate
                  ? `https://t.me/learnx1000?text=${encodeURIComponent(
                      `Hello! I want to book a visa run for ${selectedDate.getDate()} ${monthsInEnglish[selectedDate.getMonth()]} ${selectedDate.getFullYear()}.`
                    )}`
                  : "#"
              }
              target="_blank"
          ...
          <div className="mt-6 rounded-lg bg-primary-light bg-opacity-10 p-4 text-center text-sm">
            <p className="text-text-secondary">
              For current information about available dates and seats, please contact us via Telegram
            </p>
          </div>
        </div>
      </div>
