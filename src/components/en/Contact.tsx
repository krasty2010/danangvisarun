      ...
      <div className="container-custom">
        ...
        <div className="mx-auto max-w-2xl">
          <div className="rounded-2xl bg-gradient-primary p-8 text-white">
            <h3 className="mb-6 text-2xl font-semibold text-center">Contact Information</h3>
            ...
            <div className="mt-12 rounded-xl bg-white bg-opacity-20 p-6 backdrop-blur-sm">
              <h4 className="mb-4 text-xl font-medium text-center">Working Hours</h4>
              ...
              <p className="mt-4 text-sm text-center">* All times are in Vietnam time (GMT+7)</p>
            </div>
          </div>
        </div>
      </div>
